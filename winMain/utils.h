...
namespace MY_UTIL
{
	...
	void DrawTextPlus(HDC hdc, int x, int y, int width, int height, LPCSTR lpString, int size, COLORREF color, int weight, LPCSTR ttf, bool bg = FALSE, UINT format = DT_LEFT | DT_WORDBREAK);
